...
鹅和帽带企鹅的各种信息。""")
    ...
    with col_form:
        ...
        with st.form('user_inputs'):
            island = st.selectbox('企鹅栖息的岛屿', options=['托尔德岛', '比斯科岛', '德里斯科岛'])
        ...
        # 初始化数据预处理格式中与岛屿相关的变量
        island_dream, island_dream, island_torgerson = 0, 0, 0
        # 根据用户输入的岛屿数据更改对应的值
        if island == '比斯科岛':
            island_biscoe = 1
        elif island == '德里斯科岛':
        ...
        format_data = [bill_length, bill_depth, flipper_length, body_mass,
                       island_dream, island_torgerson, island_biscoe,island_biscoe, sex_male, sex_female]
